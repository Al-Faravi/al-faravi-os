...
import { 
  ...
  Plus, Trash2, Edit3, FolderOpen, Bell, Sparkles, LogOut 
} from 'lucide-react';
        ...
        <main className="max-w-5xl mx-auto p-4 md:p-8 mt-2">
          ...
          {!selectedGroup && activeTab === 'dashboard' && (
            <div className="animate-fade-in space-y-8">
              ...
              <div className="bg-gradient-to-r from-[#141516] to-[#1D1E20] dark:from-[#18191A] dark:to-[#141516] rounded-3xl p-8 border border-slate-200 dark:border-[#292B2E] shadow-xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#FF9D2E]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
                <div className="relative z-10">
                  <p className="text-[#FF9D2E] font-bold text-sm mb-2">{currentDate}</p>
                  <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-3">Welcome back, {profileName}! 👋</h2>
              ...
              <div>
                ...
                {groups.length === 0 ? (
                  <div className="bg-white dark:bg-[#18191A] rounded-3xl p-10 text-center border border-slate-200 dark:border-[#292B2E] shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {groups.map(group => (
                      <div 
                        ...
                        className="bg-white dark:bg-[#18191A] border border-slate-200 dark:border-[#292B2E] hover:border-[#FF9D2E] p-6 rounded-3xl cursor-pointer transition-all duration-300 group hover:-translate-y-1.5 hover:shadow-xl dark:hover:shadow-[#FF9D2E]/5"
                      >
                        <div className="flex items-center gap-4 mb-5">
                          <div className="w-14 h-14 bg-slate-50 dark:bg-[#1D1E20] border border-slate-200 dark:border-[#292B2E] rounded-2xl flex items-center justify-center text-[#FF9D2E] group-hover:bg-[#FF9D2E] group-hover:text-[#0D0E0F] transition-colors">
                            <FolderOpen size={28} />
                          </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex gap-4 overflow-x-auto pb-4 hide-scrollbar">
                    {allContents.slice(0, 5).map(item => (
                      <div key={item.id} className="min-w-[260px] bg-white dark:bg-[#18191A] p-4 rounded-2xl border border-slate-200 dark:border-[#292B2E] shrink-0">
                        ...
                        <p className="font-bold text-sm line-clamp-2 leading-snug">{item.title}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="animate-slide-in-right">
              ...
              {showNoteForm && (
                <form onSubmit={handleAddNote} className="bg-white dark:bg-[#18191A] p-6 rounded-3xl border border-[#FF9D2E]/30 mb-8 shadow-xl">
                  <h3 className="text-lg font-bold mb-4 flex items-center gap-2"><Edit3 size={20} className="text-[#FF9D2E]" /> Share a Note with Group</h3>
            ...
            <div className="animate-slide-in-right bg-white dark:bg-[#18191A] rounded-3xl p-6 md:p-10 shadow-lg border border-slate-200 dark:border-[#292B2E] min-h-[60vh]">
              {!isEditing ? (
                ...
                <div className="space-y-5">
                  ...
                  <input type="text" value={noteTitle} onChange={(e) => setNoteTitle(e.target.value)} className="w-full bg-slate-50 dark:bg-[#141516] border border-slate-200 dark:border-[#292B2E] focus:border-[#FF9D2E] rounded-xl p-4 font-bold text-lg outline-none transition-all" />
                  <textarea value={noteContent} onChange={(e) => setNoteContent(e.target.value)} className="w-full bg-slate-50 dark:bg-[#141516] border border-slate-200 dark:border-[#292B2E] focus:border-[#FF9D2E] rounded-xl p-4 h-[60vh] resize-none outline-none text-lg transition-all" />
                </div>
              )}
            </div>
          )}
          ...
          <div className="fixed bottom-20 md:bottom-8 right-4 md:right-8 z-[999] flex flex-col items-end">
            {isChatOpen && (
              <div className="w-[90vw] md:w-[380px] h-[500px] max-h-[80vh] bg-white dark:bg-[#141516] border border-slate-200 dark:border-[#292B2E] shadow-2xl rounded-3xl mb-4 flex flex-col overflow-hidden animate-fade-in origin-bottom-right">
                ...
                <div className="flex-1 p-4 overflow-y-auto bg-slate-100 dark:bg-[#0D0E0F]">
                  ...
                  <div className="flex flex-col items-start mb-4">
                    ...
                    <div className="bg-white dark:bg-[#1D1E20] border border-slate-200 dark:border-[#292B2E] px-4 py-2.5 rounded-2xl rounded-tl-sm text-sm shadow-sm max-w-[85%] leading-relaxed">
                ...
                <div className="p-3 bg-white dark:bg-[#18191A] border-t border-slate-200 dark:border-[#292B2E] flex items-center gap-2">
                  ...
                  <input type="text" placeholder="Type a message..." className="flex-1 bg-slate-100 dark:bg-[#1D1E20] border border-transparent focus:border-[#FF9D2E]/50 rounded-full px-4 py-2 text-sm outline-none transition-all" />
